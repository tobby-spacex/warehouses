                    ...
                    <form method="post" action="{{ route('product.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="border-b border-gray-900/10 pb-5">  
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                <input type="text" name="sku" id="sku" value="{{old('sku')}}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
